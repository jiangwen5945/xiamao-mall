<template>
  <div class='sub-sort'>
    ...
    <div class="check">
      <JCheckbox v-model="sortParams.inventory" @change="changeChecked">仅显示有货商品</JCheckbox>
      <JCheckbox v-model="sortParams.onlyDiscount"  @change="changeChecked">仅显示特惠商品</JCheckbox>
    </div>
  </div>
</template>
<script>
...
export default {
  ...
  setup (props, { emit }) {
    ...
    const sortParams = reactive({
      ...
      sortField: null, // ==>排序方式: publishTime,orderNum,price,evaluateNum
